...
const DoctorSignup = () => {
  ...
  return (
    <Box sx={{ maxWidth: 400, mx: 'auto', mt: 8, p: 3, bgcolor: 'white', borderRadius: 2, boxShadow: 2 }}>
      <Typography variant="h5" align="center" gutterBottom>Doctor Signup</Typography>
      ...
      <Box component="form" onSubmit={handleSubmit}>
        ...
        <TextField margin="normal" required fullWidth label="Experience (years)" name="experience" type="number" />
